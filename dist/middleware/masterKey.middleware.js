...
exports.requireMasterKey = requireMasterKey;
exports.optionalMasterKey = optionalMasterKey;
/**
 ...
 * @param next - Express next function
 */
async function optionalMasterKey(req, res, next) {
    try {
        const masterApiKey = process.env.MASTER_API_KEY;
        const apiKey = req.headers['x-api-key'] || req.headers['X-API-Key'];
...
exports.default = requireMasterKey;
//# sourceMappingURL=masterKey.middleware.js.map