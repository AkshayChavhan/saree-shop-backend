...
const masterKey_middleware_1 = require("../masterKey.middleware");
    ...
    describe('requireMasterKey', () => {
        describe('when MASTER_API_KEY is not configured', () => {
            ...
            it('should return 500 error', async () => {
                await (0, masterKey_middleware_1.requireMasterKey)(mockRequest, mockResponse, nextFunction);
        ...
        describe('when bypass is enabled in development', () => {
            ...
            it('should log warning when bypassed', async () => {
                ...
                await (0, masterKey_middleware_1.requireMasterKey)(mockRequest, mockResponse, nextFunction);
                expect(warnSpy).toHaveBeenCalledWith('⚠️  Master API key check bypassed (development mode)');
            });
        });
    ...
    describe('optionalMasterKey', () => {
        ...
        describe('when no API key is provided', () => {
            it('should call next without validation', async () => {
                await (0, masterKey_middleware_1.optionalMasterKey)(mockRequest, mockResponse, nextFunction);
                expect(nextFunction).toHaveBeenCalled();
                expect(statusSpy).not.toHaveBeenCalled();
            });
        });
...
//# sourceMappingURL=masterKey.middleware.test.js.map